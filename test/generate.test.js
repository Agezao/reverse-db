...
describe(helpers.getTestDialectTeaser("reverse-db"), function() {
  after(function(done) {
  ...
  var setupModels = function(self, callback) {
    ...
    var execString = "node " + path.join(__dirname, "..", "bin", "reverse-db") + " -o \"" + testConfig.directory + "\" -d " + config.database + " -h " + config.host;
